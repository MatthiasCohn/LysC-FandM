...
- Capture Lessons: Update skillsagent.md with any change in approach the user has asked you to make.
...
3. **Test Diven Development**: Write tests first, then implement.
